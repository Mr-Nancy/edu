...
# Creating sequences
s1 <- seq(1,10, by=2); s1               # step = 2
s2 <- seq(1,10, length=3); s2           # creates a vector with exaclty 3 elements
x <- c(1,3,8,25,100); seq(along = x)    # seq(along = x) takes the length of generated sequence from the vector x
